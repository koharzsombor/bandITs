/**
 * ADD_SPORE parancs implementációja.
 */
public class AddSporeCommand extends CommandImpl {
    /**
     ...
     */
    public AddSporeCommand(InputCommand inputCommand, Player actor) {
    ...
    public void execute(CommandHandler handler) {
        try {
            ...
            MushroomBody mushroomBody = (MushroomBody)ObjectRegistry.getObject(input.params()[2]);
            mushroomBodyController.addSpores(input.params()[0], input.params()[1], mushroomBody);
        } catch (Exception e) {
