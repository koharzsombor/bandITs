...
/**
 * Swing-es megjelenitese egy MultiLayeredTectonnak
 */
public class SwingMultiLayeredTecton extends JPanel implements Updatable, SwingTecton{
     ...
     * Tecton szine
     */
    private Color tectonColor = new Color(0, 0, 255);
     ...
     */
    SwingMultiLayeredTecton(MultiLayeredTectonImpl tecton) {
    ...
    @Override
    public void update() {
        setToolTipText("MultiLayeredTecton: " + ObjectRegistry.lookupName(tectonView) + " | " +
